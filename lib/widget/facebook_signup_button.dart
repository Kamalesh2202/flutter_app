        ...
        child: _isLoggedIn ? Container(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 8),
              Text('Name: ' + _userObj ["name"], style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 20)),
              SizedBox(height: 8),
              Text('Email: ' + _userObj["email"], style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 20)),
              SizedBox(height: 16),
              ElevatedButton(
                child: Text("Logout"),
                onPressed: (){
